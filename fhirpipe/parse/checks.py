...
def assert_has_sql_type(name_type, value):
    ...
    Is used to compare the type described in the fhir documentation and
    the type returned from the sql query and the cleaning scripts

    args:
        name_type: type in the fhir documentation
        value: value returned for sql + scripts
    """
